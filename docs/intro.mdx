...
- Proximity Voice Chat: The server uses [Simple Voice Chat](https://modrinth.com/plugin/simple-voice-chat) for proximity voice chat.
  - Read further on the [setup here of voice chat](/docs/server-life/voice-chat)
